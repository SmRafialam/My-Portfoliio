  ...
  return (
    <Section id="contact">
      ...
      <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
        {/* Info side */}
        <Reveal>
          <div className="flex h-full flex-col justify-between gap-6 rounded-3xl border border-white/10 bg-gradient-to-br from-card to-surface p-8">
            <div>
            ...
            <div className="space-y-4">
              <a href={`mailto:${profile.email}`} className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/[0.03] p-4 transition-colors hover:border-accent/40">
              ...
              {socials.map((s) => {
                ...
                return (
                  <a
                    ...
                    rel="noreferrer"
                    aria-label={s.name}
                    className="grid h-11 w-11 place-items-center rounded-full border border-white/10 text-slate-300 transition-all hover:-translate-y-1 hover:border-accent/50 hover:text-white hover:shadow-glow"
                  >
                    <Icon size={17} />
                  </a>
                )
          ...
          <form onSubmit={onSubmit} className="glass rounded-3xl p-8">
            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-slate-600 focus:border-accent"
                />
              </div>
              <div>
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-slate-600 focus:border-accent"
              />
            </div>
